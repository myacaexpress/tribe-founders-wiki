...
describe("Add Something page", () => {
  ...
  it("can switch destination to Brainstorm", async () => {
    ...
    const brainstormBtn = screen.getByText("Brainstorm").closest("button");
    expect(brainstormBtn).toBeTruthy();
  });
